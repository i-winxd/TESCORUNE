...
function BombTD:onStart()
    ...
    table.insert(path, { top_x, SCREEN_HEIGHT })
    ...
    self.timer:script(function(wait) 
        local spawn_waves = {{0.4, 12, 0.2, 80}, {4, 13, 0.2, 160}, {4, 2, 0.6, 220}}
        local total_bombs = 0
        ...
        for i = 1, #spawn_waves do
            ...
            for j = 1, spawn_count do
                ...
                local spawned_bomb = self:spawnBullet("tesco_bag_path", the_path, velo, function() 
